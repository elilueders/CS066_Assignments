...
def time_list_operation(input_list,list_operation,num_experiment_repetitions):
    """
...
def run_list_op_timing_experiments(sizes_of_lists,list_operation,num_experiment_repetitions):
    """
    ...
    for test_list in test_lists:
        ...
        current_experiment_run_time = time_list_operation(test_list,list_operation,num_experiment_repetitions)
...
def pop_last(test_list):
    result = test_list.pop()
    return result

def pop_first(test_list):
...
def access_random_int(test_list):
    x = random.randint(0,len(test_list)-1)
    result = test_list.remove(x)
    return result

list_sizes = range(100000,2000001,100000)
# results = run_list_op_timing_experiments(list_sizes,search_val_0,20)
# results = run_list_op_timing_experiments(list_sizes,pop_last,20)
results = run_list_op_timing_experiments(list_sizes,sort_list,20)
# results = run_list_op_timing_experiments(list_sizes,access_random_int,20)
